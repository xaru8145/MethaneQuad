...
static const char qt_meta_stringdata_MainWindow[] = {
    ...
    "\0on_imageTopicsRefresh_button_clicked()\0"
    "on_saveImages_button_clicked()\0"
    "on_imageTopics_comboBox_currentIndexChanged(int)\0"
    "index\0on_imageTopics_comboBox_2_currentIndexChanged(int)\0"
    "on_pushButton_saveLeft_clicked()\0"
    "on_pushButton_saveRight_clicked()\0"
    "enableMotion(bool)\0check\0updateTimeBoxes()\0"
    "updateWheelSpeeds(autorally_msgs::wheelSpeedsConstPtr)\0"
    "msg\0updateActuatorData(autorally_msgs::chassisStateConstPtr)\0"
    "setEnableLabel(QLabel*,bool)\0label,enabled\0"
    "setControl(bool)\0sendChassisCommand()\0"
    "setSteering(int)\0val\0setThrottle(int)\0"
