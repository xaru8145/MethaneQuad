...
class stateEstimatorStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new stateEstimatorStatus(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new stateEstimatorStatus(null);
...
stateEstimatorStatus.Constants = {
  OK: 0,
  WARN: 1,
  ERROR: 2,
}

module.exports = stateEstimatorStatus;
