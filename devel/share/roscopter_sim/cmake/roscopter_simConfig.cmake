...
if(roscopter_sim_CONFIG_INCLUDED)
  return()
endif()
set(roscopter_sim_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'roscopter_sim' is deprecated")
...
if(NOT "/home/xaru8145/catkin_ws/src/roscopter/roscopter_sim/include;/usr/include/eigen3;/usr/include;/usr/include/gazebo-7;/usr/include/sdformat-4.0;/usr/include/ignition/math2;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging " STREQUAL " ")
  set(roscopter_sim_INCLUDE_DIRS "")
  set(_include_dirs "/home/xaru8145/catkin_ws/src/roscopter/roscopter_sim/include;/usr/include/eigen3;/usr/include;/usr/include/gazebo-7;/usr/include/sdformat-4.0;/usr/include/ignition/math2;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${roscopter_sim_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'roscopter_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xaru8145/catkin_ws/src/roscopter/roscopter_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND roscopter_sim_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(roscopter_sim_LIBRARY_DIRS ${lib_path})
      list(APPEND roscopter_sim_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'roscopter_sim'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND roscopter_sim_LIBRARIES ${lib})
    endif()
  endif()
...
set(roscopter_sim_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${roscopter_sim_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 roscopter_sim_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${roscopter_sim_dep}_FOUND)
      find_package(${roscopter_sim_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${roscopter_sim_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(roscopter_sim_INCLUDE_DIRS ${${roscopter_sim_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(roscopter_sim_LIBRARIES ${roscopter_sim_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${roscopter_sim_dep}_LIBRARIES})
  _list_append_deduplicate(roscopter_sim_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(roscopter_sim_LIBRARIES ${roscopter_sim_LIBRARIES})

  _list_append_unique(roscopter_sim_LIBRARY_DIRS ${${roscopter_sim_dep}_LIBRARY_DIRS})
  list(APPEND roscopter_sim_EXPORTED_TARGETS ${${roscopter_sim_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${roscopter_sim_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
