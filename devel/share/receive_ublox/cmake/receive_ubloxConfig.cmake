...
if("TRUE" STREQUAL "TRUE")
  set(receive_ublox_SOURCE_PREFIX /home/odroid/catkin_ws/src/receive_ublox)
  set(receive_ublox_DEVEL_PREFIX /home/odroid/catkin_ws/devel)
  ...
  set(receive_ublox_INSTALL_PREFIX /home/odroid/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/receive_ublox " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/receive_ublox' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'receive_ublox' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'receive_ublox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/catkin_ws/src/receive_ublox/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${receive_ublox_dep}_FOUND)
      find_package(${receive_ublox_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${receive_ublox_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
