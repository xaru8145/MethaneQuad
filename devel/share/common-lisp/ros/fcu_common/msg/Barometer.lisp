...
(cl:defmethod cl:initialize-instance :after ((m <Barometer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Barometer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fcu_common-msg:<Barometer> is deprecated: use fcu_common-msg:Barometer instead.")))
...
(cl:defmethod pressure-val ((m <Barometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fcu_common-msg:pressure-val is deprecated.  Use fcu_common-msg:pressure instead.")
  (pressure m))
