...
(cl:defmethod cl:initialize-instance :after ((m <Airspeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Airspeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fcu_common-msg:<Airspeed> is deprecated: use fcu_common-msg:Airspeed instead.")))
...
(cl:defmethod differential_pressure-val ((m <Airspeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fcu_common-msg:differential_pressure-val is deprecated.  Use fcu_common-msg:differential_pressure instead.")
  (differential_pressure m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <Airspeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fcu_common-msg:temperature-val is deprecated.  Use fcu_common-msg:temperature instead.")
  (temperature m))
